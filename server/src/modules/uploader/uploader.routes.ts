...
router.route('/plan-uploads').post(clerkMiddleware, uploaderController.handlePlanUploads)

router.route('/generate-url').post(clerkMiddleware, uploaderController.generateUploadUrl)
