...
import { CreateDocumentDialog, useDefaultWorkspace, useDocuments, WorkspaceProvider } from '@/features'
...
// import { useSidebar } from '@/features/drafts/api/get-sidebar-drafts'
                        ...
                        <div className="grid grid-cols-2 gap-3.5 sm:grid-cols-3 lg:grid-cols-5">
                            {filteredDocuments.map((doc) => (
                                <DocumentCard
                                    ...
                                    document={doc}
                                    workspaceId={workspaceId!}
                                    onDocumentClick={() => navigate(`/documents/${doc.id}`)}
                                />
                            ))}
                        </div>
                    )}
